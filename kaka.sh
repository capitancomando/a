...
function menu_principal() {
	...
	sleep .05s; echo -e "${verde}[${blanco}1${verde}] ${blanco}Doxear a una persona.${final}\n"
	sleep 0.7s; echo -e "${verde}[${blanco}2${verde}] ${blanco}Doxear una web.${final}\n"
...
function dox_1 {
	...
	echo -e "${verde}[${blanco}1${verde}]${final} ${rojo}Buscar por Nombre${final}\n"; sleep 0.7s
